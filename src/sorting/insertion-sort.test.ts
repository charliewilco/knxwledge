...
describe("InsertionSort", () => {
	describe("sort", () => {
		...
		it("should sort an array of objects in ascending order based on a numeric property", () => {
			const arr = [
				{ id: 3, name: "C" },
				{ id: 1, name: "A" },
				{ id: 4, name: "D" },
		...
		it("should sort an array of objects in descending order based on a string property", () => {
			const arr = [
				{ id: 3, name: "C" },
				{ id: 1, name: "A" },
				{ id: 4, name: "D" },
			...
			expect(InsertionSort.sort(arr, (a, b) => b.name.localeCompare(a.name))).toEqual(
				expected
			);
		});

		it("should sort an array of numbers in descending order using a custom comparison function", () => {
			const arr = [5, 1, 4, 2, 8];
		...
		it("should handle an array with negative values", () => {
			const arr = [5, -1, 4, -2, 8];
			const expected = [-2, -1, 4, 5, 8];
			expect(InsertionSort.sort(arr)).toEqual(expected);
		});

		it("should handle an array with all negative values", () => {
			const arr = [-5, -1, -4, -2, -8];
			const expected = [-8, -5, -4, -2, -1];
			expect(InsertionSort.sort(arr)).toEqual(expected);
		});
